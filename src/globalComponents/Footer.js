    ...
    <footer>
          ...
          <div>
            ...
            <ul className="mt-5">
              <li className="flex justify-start items-center text-neutral gap-1 mb-3 hover:text-accent">
                ...
                <Link to="#">Softwear Enginner</Link>
              </li>
          ...
          <div>
            ...
            <div className="flex justify-start items-center gap-3 mb-3">
              ...
              <div className="text-neutral">
                <h4>Sector 24, Industrial Phase</h4>
                <h2>Cresect Square, Mumbai</h2>
              </div>
            </div>
      ...
      <div className="p-4 bg-[#222] text-base-100">
        <div className="flex justify-center items-center">
          <p className="text-xs">
            Copyright © 2022 - All right reserved: Jobify.com
          </p>
        </div>
      </div>
    </footer>
