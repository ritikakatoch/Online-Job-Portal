...
const Navbar = () => {
  ...
  const stickNavbar = () => {
    if (window !== undefined) {
      ...
      windowHeight > 250
        ? setStickyClass("fixed top-0 left-0 z-50 bg-blue shadow-lg")
  ...
  return (
    <header>
      {/* ......Mini navbar start...... */}
      <div className="py-3 bg-Aquamarine hidden sm:block">
        <div className="flex justify-between container mx-auto px-5">
          ...
          <div>
            <ul className="flex bg-Aquamarine text-sm gap-2 md:gap-3 md:text-base font-bold">
              {user?.name ? (
