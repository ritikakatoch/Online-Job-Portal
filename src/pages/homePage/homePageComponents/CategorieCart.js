...
const CategorieCart = (categorie) => {
  ...
  return (
    <div className="flex justify-start items-center bg-base-100 shadow gap-4 px-5 py-5 cursor-pointer hover:-translate-y-1 duration-700 hover:shadow-lg border-white border hover:border-success">
