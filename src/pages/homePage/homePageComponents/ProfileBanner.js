      ...
      <div className="grid lg:grid-cols-2 justify-center items-center px-5 gap-10 container mx-auto">
        ...
        <div className="flex justify-center items-center">
          <div>
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-black mb-3 md:mb-5">
              Create account here:
            </h1>
            ...
            <button className="btn rounded-none px-4 md:px-7 duration-700 py-3 bg-success hover:bg-transparent text-white border-primary hover:border-primary hover:text-primary font-bold border-2 hover:border-2">
              Create Profile
            </button>
          </div>
        </div>
