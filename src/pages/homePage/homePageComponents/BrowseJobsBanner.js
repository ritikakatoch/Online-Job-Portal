    ...
    <div className="bg-[#E0FFFF]">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 py-16 items-center container mx-auto px-5">
        <div>
          ...
          <Link
            to="/jobs"
            className="btn w-[200px] rounded-none duration-700 flex itmes-center px-4 md:px-7 py-3 bg-success hover:bg-transparent text-white border-primary hover:border-primary hover:text-primary font-bold border-2 hover:border-2"
          >
